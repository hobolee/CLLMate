...
# load the prompt and image from json file
prompt_path = "./data/prompt_dict.json"
import json
...
for key, prompt in prompt_dict.items():
    image_file = r"./data/image_sampled/{}.png".format(key)
    ...
    with open("./data/model_output/output_dict_internvl3_2b.json", "w") as f:
